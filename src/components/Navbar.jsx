  ...
  return (
    <nav>
      <div className="container text-black flex bg-red-300 py-4 px-6 justify-between">
        <div className="logo flex items-center bg-white rounded-lg border border-black px-2">
        ...
        <div className="search flex items-center  border-black border-2 ">
          <input
          ...
          <div className="search-icon ">
            <button className="flex items-center border-2 border-t-0 border-black border-r-0 border-b-0 ">
